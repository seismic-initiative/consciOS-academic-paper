...
% List spacing (reduce excessive space before/after lists)
\usepackage{enumitem}
\setlist{topsep=6pt, partopsep=0pt, itemsep=3pt, parsep=3pt}
...
\fancypagestyle{plain}{%
  ...
  \fancyhead[L]{\raisebox{-8pt}{\hspace{-5pt}\includegraphics[height=30pt]{seismic-logo.png}}}
